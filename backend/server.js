...
শেষ`
        ...
        {
            id: 5,
            title: 'নেস্টেড যদি-নাহলে স্টেটমেন্ট',
            code: `শুরু
    পূর্ণ নম্বর = ৭৫;
    
    যদি (নম্বর >= ৮০) {
        দেখাও << "গ্রেড: A" << নতুনলাইন;
    } 
    নাহলে যদি (নম্বর >= ৬০) {
        দেখাও << "গ্রেড: B" << নতুনলাইন;
    } 
    নাহলে যদি (নম্বর >= ৪০) {
        দেখাও << "গ্রেড: C" << নতুনলাইন;
    } 
    নাহলে {
        দেখাও << "গ্রেড: F" << নতুনলাইন;
    }
শেষ`
        },
        {
...
শেষ`
    ...
    দেখাও << "আসসালামু আলাইকুম, " << নাম << "!" << নতুনলাইন;
শেষ`
        },
        {
            id: 9,
